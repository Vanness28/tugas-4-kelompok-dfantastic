    ...
    <>
        <div className="">
            ...
            <div className="absolute min-[320px]:-mt-9 min-[320px]:ml-10 min-[375px]:-mt-10 min-[375px]:ml-16 min-[425px]:-mt-12 min-[425px]:ml-24 md:-mt-72 md:ml-12 lg:-mt-80 lg:ml-14 xl:ml-72">
                <div className="bg-white rounded-lg mx-auto w-60  mt-1 min-[320px]:h-5 min-[375px]:h-7 md:rounded-2xl md:w-80 md:h-12 md:ml-44 md:mt-56 lg:ml-64 lg:w-96 lg:h-16"></div>
