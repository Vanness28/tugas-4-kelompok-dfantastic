...
const Recommendation3 = () => {
    ...
    <div className="grid grid-cols-1 mt-3 gap-3 md:mt-0 md:grid md:grid-cols-3 md:gap-5 md:pr-20 lg:pr-12 xl:pr-10">
        <div className="relative mt-7 ml-10 pr-8 md:w-64 lg:w-80 xl:w-full">
                <img src={Rekom4} alt="" className="rounded-lg w-screen h-44 min-[425px]:h-52 md:h-full"/>
        ...
        <div className="relative mt-7 ml-10 pr-8 md:w-64 lg:w-80 xl:w-full">
                <img src={Rekom5} alt="" className="rounded-lg w-screen h-44 min-[425px]:h-52 md:h-full"/>
            <div className="absolute bottom-2 left-6 md:left-4 text-white xl:left-8">
        ...
        <div className="relative mt-7 ml-10 pr-8 md:w-64 lg:w-80 xl:w-full">
                <img src={Rekom6} alt="" className="rounded-lg w-screen h-44 min-[425px]:h-52 md:h-full"/>
